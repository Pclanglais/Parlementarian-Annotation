...
This annotation scheme is an "operationalized" scheme in a finetuned Gemma-4b model.

It includes three different range of annotations, the first two ones being "global" (ie requiring the entire debate section) while the last one is "local" (based on the decontextualized speech intervention).

## Proposal Section [Global]
...
## Debate Section [Global]
Like the proposal section, the debate section is annotating an entire sequence of speeches on a given topic.
...
- `Anger` - Hostile or combative tone
